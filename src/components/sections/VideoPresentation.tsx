...
export default function VideoPresentation({
  ...
  const videoStructuredData = {
    ...
    name:
      videoTitle ||
      "Présentation de Christophe Mostefaoui - Développeur Web Full-Stack Expert",
    description:
      videoDescription ||
      "Découvrez mon expertise en développement web full-stack avec React.js, Node.js et TypeScript. Création d'applications SaaS et e-commerce sur mesure à Pau.",
    thumbnailUrl:
      videoThumbnail ||
      "https://christophe-dev-freelance.fr/video-thumbnail.jpg",
    ...
    embedUrl: youtubeUrl
      ? youtubeUrl.replace("http://", "https://")
      : "https://www.youtube.com/embed/tdjXblz4mr4",
    publisher: {
      "@type": "Person",
      ...
      >
          ...
          >
            ...
            <motion.div variants={itemVariants} className="mb-16">
              <motion.h1
                ...
                style={{
                  backgroundImage:
                    "linear-gradient(45deg, #06b6d4, #8b5cf6, #ec4899, #10b981)",
              ...
              >
                Découvrez mon expertise en conception et développement
                d'applications web. Spécialiste{" "}
                <strong>React.js, Node.js et TypeScript</strong>, je crée des
                applications SaaS performantes et des solutions e-commerce sur
                mesure à <strong>Pau</strong>, dans les Pyrénées-Atlantiques
                ainsi qu'à distance.
              </motion.p>
            ...
            >
                    ...
                    {youtubeUrl && isPlaying ? (
                      ...
                      >
                        <article className="text-center">
                          ...
                          >
                            {youtubeUrl
                              ? "▶️ Regarder ma présentation vidéo"
                              : "Présentation Christophe Mostefaoui - Développeur Full-Stack"}
                          </h3>
                          <div className="mt-8 text-sm text-gray-400">
                            {youtubeUrl
                              ? "🎬 Cliquez pour charger la vidéo | ⚡ Chargement optimisé"
                          ...
                          <meta
                            itemProp="uploadDate"
                            content="2024-12-01T10:00:00Z"
                          />
                          <meta
                            itemProp="author"
                            content="Christophe Mostefaoui"
                          />
                          <meta
                            itemProp="publisher"
                            content="Christophe Mostefaoui - Développement Web"
                          />
                        </article>
                      </div>
                    )}
              ...
              <div
                className="absolute -top-2 -right-2 w-4 h-4 bg-purple-400 rounded-full animate-pulse opacity-60"
                style={{ animationDelay: "0.5s" }}
              />
              <div
                className="absolute -bottom-2 -left-2 w-4 h-4 bg-pink-400 rounded-full animate-pulse opacity-60"
                style={{ animationDelay: "1s" }}
              />
              <div
                className="absolute -bottom-2 -right-2 w-4 h-4 bg-emerald-400 rounded-full animate-pulse opacity-60"
            ...
            <motion.div
              ...
              style={{
                background:
                  "linear-gradient(90deg, transparent, #06b6d4, #8b5cf6, #ec4899, transparent)",
        ...
        <div className="sr-only" aria-hidden="true">
          ...
          <p>
            ...
            spécialisé dans les technologies modernes : React.js, Node.js,
            TypeScript, MongoDB, MySQL, Docker. Expert en applications SaaS et
            solutions e-commerce sur mesure pour entreprises locales et
            nationales.
          </p>
          <address>
          ...
          <p>
            ...
            Pau, expert Node.js Pyrénées-Atlantiques, créateur applications SaaS
            France, développement TypeScript professionnel, consultant technique
            web, freelance développeur full-stack Béarn, programmeur JavaScript
            senior, architecte logiciel web, spécialiste API REST, expert
            MongoDB MySQL, intégration Stripe paiements, développement agile,
            création sites e-commerce performants, optimisation Core Web Vitals,
